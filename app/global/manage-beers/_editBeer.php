<?php
//HTML and any necessary PHP for generating the form that allows the user to edit a beer. 
//This file should not include the PHP code that actually updates the database row, that goes in the index.php file under the case for edit...
